...
public class Find_Match {
	...
	public Map<String, Double> search(String queryname) {
		...
		System.out.println("Parsing Audio Successfull!");
		queryV.readAndextractVideo();
		System.out.println("Parsing Image Successfull!");
		
		queryV.extractColor();
		System.out.println("Color Parsing SuccessFULL!");
		System.out.println("");
		...
		System.out.println("Frame Comparison Complete!");
		...
		//	System.out.println("Vvvvvvvvvviiiiiiiiidddddddddeeeeeeeeoooooooooonnnnuuumb4rrer "+i);
			...
			for(int j = 0;j < 250;j++) {
				...
				//System.out.println("resemblevalue:"+resembleValues[j]);
				//System.out.println("resembleclips:"+resembleClips[j]);
			}
		...
		System.out.println("Compare_Color Complete!");
		System.out.println("Compare_Audio Complete!");
	...
	public void init() throws IOException{
		vs = new Parse_Files[7];
		for(int i = 0;i < 7;i++) {
			vs[i] = new Parse_Files(600, 0);
		}
